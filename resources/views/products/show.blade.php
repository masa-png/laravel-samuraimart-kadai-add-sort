    ...
    <div class="d-flex justify-content-center">
        <div class="row w-75">
            ...
            <div class="col">
                ...
                @auth
                    <form class="m-3 align-items-end" method="POST">
                        @csrf
                    ...
                    <form id="favorites-destroy-form" action="{{ route('favorites.destroy', $product->id) }}" method="POST"
                        class="d-none">
                        @csrf
                        @method('DELETE')
                    </form>
                    <form id="favorites-store-form" action="{{ route('favorites.store', $product->id) }}" method="POST"
                        class="d-none">
                        @csrf
                    </form>
                @endauth
